      ...
      <div ref={innerRef} className="hero-container">
        ...
        <div className="hero-content" style={{ display: 'flex', flexDirection: 'column', gap: '26px' }}>
          ...
          <div className="hero-badge" style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: 'rgba(240,165,0,.08)', border: '1px solid rgba(240,165,0,.22)', color: 'var(--gold)', fontSize: '11.5px', fontWeight: 600, letterSpacing: '.09em', textTransform: 'uppercase', padding: '6px 14px', borderRadius: '100px', width: 'fit-content', opacity: 0, animation: 'fadeUp .7s .1s cubic-bezier(.16,1,.3,1) forwards' }}>
            ...
            <span className="badge-text">Trusted by 15,000+ Families</span>
          ...
          <h1 className="word-reveal hero-h1" style={{ fontFamily: 'var(--font-playfair)', fontSize: 'clamp(2.4rem, 4.8vw, 4.9rem)', fontWeight: 700, lineHeight: 1.06, letterSpacing: '-.03em' }}>
            ...
            <span className="word" style={{ marginRight: '0.25em' }}><span>Your</span></span><br className="hidden md:block" />
            <span className="word" style={{ marginRight: '0.25em' }}><span>Wealth</span></span><br className="hidden md:block" />
            <span className="word" style={{ marginRight: '0.25em' }}><span className="gold-grad">With Precision</span></span><br className="hidden md:block" />
        ...
        <div className="hero-viz" style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', height: '560px', opacity: 0, animation: 'fadeUp .9s .28s cubic-bezier(.16,1,.3,1) forwards' }}>
          <FinanceCanvas />
          {/* Floating cards */}
          <div className="hero-card-1" style={{ position: 'absolute', top: '5%', right: '-2%', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)', borderRadius: '16px', padding: '18px 22px', minWidth: '192px', background: 'rgba(255,255,255,.10)', border: '1px solid rgba(255,255,255,.14)', boxShadow: '0 8px 32px rgba(0,0,0,.2)', animation: 'heroCardIn .8s 1.1s cubic-bezier(.16,1,.3,1) both, floatY 5.5s 2s ease-in-out infinite', zIndex: 10 }}>
            <div style={{ fontSize: '10px', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '.1em', color: 'rgba(255, 255, 255, 0.5)', marginBottom: '5px' }}>Avg Annual Returns</div>
          ...
          <div className="hero-card-2" style={{ position: 'absolute', bottom: '8%', left: '-2%', backdropFilter: 'blur(24px)', WebkitBackdropFilter: 'blur(24px)', borderRadius: '16px', padding: '18px 22px', minWidth: '192px', background: 'rgba(255,255,255,.09)', border: '1px solid rgba(255,255,255,.12)', boxShadow: '0 8px 32px rgba(0,0,0,.18)', animation: 'heroCardIn .8s 1.3s cubic-bezier(.16,1,.3,1) both, floatY2 6.5s 2.4s ease-in-out infinite', zIndex: 10 }}>
