export default function Ticker() {
  const items = ['Energy & Infrastructure', 'Manufacturing', 'Healthcare', 'Asset & business Management', 'Tax Optimisation', 'Small & Medium Enterprises (SMEs)', 'Retail & Consumer Goods', 'Technology and Fintech','Real Estate'];
